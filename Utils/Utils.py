...
def evaluate(embeds, scores,ratio, idx_train, idx_val, idx_test, label, nb_classes,
        ...
        # val_f1_macro = f1_score(val_lbls.cpu(), preds.cpu())
        # val_f1_micro = f1_score(val_lbls.cpu(), preds.cpu())
        ...
        # test_f1_macro = f1_score(test_lbls.cpu(), preds.cpu())
        # test_f1_micro = f1_score(test_lbls.cpu(), preds.cpu())
